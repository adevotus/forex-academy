...
<div class="flex min-h-screen flex-col lg:flex-row">
    ...
    {{-- ═══════════════════════════════════════════════════
         LEFT  —  Brand panel (same slider, different active slide)
    ═══════════════════════════════════════════════════ --}}
    <div class="relative hidden overflow-hidden bg-brand-panel lg:flex lg:w-5/12 lg:flex-col">
        ...
        {{-- Static welcome content for register --}}
        <div class="relative z-10 flex flex-1 flex-col justify-center px-10 pb-6">
            ...
            <div class="mt-8 space-y-4">
                ...
                ] as [$path, $label, $iconClass])
                    <div class="flex items-center gap-3">
                        <span class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg ring-1 {{ $iconClass }}">
    ...
    <div class="flex flex-1 flex-col items-center justify-center overflow-y-auto bg-white px-6 py-12 sm:px-10">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-6 text-center text-sm text-slate-500">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-brand-500 hover:text-brand-600 transition">&larr; Log in</a>
            </div>
        </div>
    </div>
</div>
