<x-layouts.admin :title="$testimonial->exists ? 'Edit Testimonial' : 'New Testimonial'">
    <x-slot name="header">
        <div>
            ...
            <div class="space-y-6 lg:col-span-2">
                    ...
                    <div class="p-6 space-y-5">
                                ...
                                @for($i = 1; $i <= 5; $i++)
                                    <label class="cursor-pointer">
                                        <input type="radio" name="rating" value="{{ $i }}"
                                               class="sr-only"
                                               @checked(old('rating', $testimonial->rating) == $i)>
                                        <svg id="star-{{ $i }}"
                                             class="h-8 w-8 transition {{ old('rating', $testimonial->rating) >= $i ? 'text-gold-400' : 'text-slate-200' }}"
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="5"
                                      class="input" placeholder="Write what the member said about us…" required>{{ old('content', $testimonial->content) }}</textarea>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        @error('media')<p class="mt-1 text-xs text-rose-500">{{ $message }}</p>@enderror
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="card p-6 space-y-3">
                    ...
                    <button type="submit" class="btn-primary w-full py-2.5">
                        ...
                        {{ $testimonial->exists ? 'Save Changes' : 'Add Testimonial' }}
                    </button>
                    <a href="{{ route('admin.testimonials.index') }}"
