<x-layouts.admin title="Courses">
    <x-slot name="header">
        ...
        <a href="{{ route('admin.courses.create') }}" class="btn-primary !py-2 text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($courses as $course)
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 font-medium text-slate-700">{{ $course->priceFormatted() }}</td>
                            <td class="px-6 py-4">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <a href="{{ route('admin.courses.create') }}" class="btn-primary !py-1.5 !text-xs">Create your first course</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
