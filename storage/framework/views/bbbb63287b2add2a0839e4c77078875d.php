            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="tel:+2348000000000" class="mt-1 block text-sm font-semibold text-slate-800 hover:text-brand-600 transition">+234 800 000 0000</a>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:support@emmioxforex.com" class="mt-1 block text-sm font-semibold text-slate-800 hover:text-brand-600 transition">support@emmioxforex.com</a>
                ...
                <div class="flex items-start gap-4">
                    <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-sky-50 text-sky-600">
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wider text-slate-400">Telegram Community</p>
                        <a href="https://t.me/EmmioxForex" target="_blank" rel="noopener" class="mt-1 block text-sm font-semibold text-slate-800 hover:text-brand-600 transition">@EmmioxForex</a>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="subject" value="<?php echo e(old('subject')); ?>"
                                       placeholder="+234 800 000 0000 — or type your subject"
