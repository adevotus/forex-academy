    ...
    <section class="relative px-4 pb-28 pt-20 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
            ...
            <span class="badge mx-auto">
                <svg class="h-3.5 w-3.5 text-gold-500" fill="currentColor" viewBox="0 0 24 24"><path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 0 0 .95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 0 0-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 0 0-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 0 0-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 0 0 .951-.69l1.519-4.674z"/></svg>
                Forex Education + Trading Technology + Mentorship
            </span>
            ...
            <div class="mx-auto mt-16 grid max-w-2xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-slate-200 shadow-card sm:grid-cols-4">
                <?php $__currentLoopData = [['4', 'Learning Levels'], ['2', 'Trading Robots'], ['3-Month', 'Signal Access'], ['1-on-1', 'Mentorship']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$stat, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white px-6 py-5 text-center">
                        <div class="text-2xl font-extrabold text-slate-900"><?php echo e($stat); ?></div>
                        <div class="mt-1 text-xs font-medium text-slate-500"><?php echo e($label); ?></div>
                    </div>
