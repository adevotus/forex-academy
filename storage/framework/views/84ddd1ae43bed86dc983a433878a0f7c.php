...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Profile']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="card overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="flex flex-col items-center justify-center gap-4 border-b border-slate-100 bg-gradient-to-b from-slate-50 to-white p-8 text-center lg:border-b-0 lg:border-r">
                ...
                <div>
                    <p class="text-lg font-extrabold text-slate-900"><?php echo e(auth()->user()->name); ?></p>
                    <p class="mt-0.5 text-sm text-slate-500"><?php echo e(auth()->user()->email); ?></p>
                ...
                <div class="mt-2 w-full space-y-2 rounded-xl border border-slate-100 bg-white p-4 text-left">
                    ...
                    <div class="flex items-center justify-between text-xs">
                        ...
                        <span class="font-semibold text-slate-700"><?php echo e(auth()->user()->created_at->format('M Y')); ?></span>
                    </div>
                    <?php if(auth()->user()->phone): ?>
                    <div class="flex items-center justify-between text-xs">
                        <span class="text-slate-500">Phone</span>
                        <span class="font-semibold text-slate-700"><?php echo e(auth()->user()->phone); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-span-2 p-8">
                ...
                <form method="POST" action="<?php echo e(route('admin.profile.update')); ?>" class="space-y-5">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-6 card overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('admin.profile.password')); ?>" class="p-8">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
...
<?php endif; ?>
<?php /**PATH D:\projects\emmiox-academy\emmiox-academy\resources\views\admin\profile.blade.php ENDPATH**/ ?>