...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => $title ?? 'Member Dashboard']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title ?? 'Member Dashboard')]); ?>
    <div class="flex min-h-screen bg-navy-900">
        
        <aside class="hidden w-64 flex-col border-r border-white/5 bg-navy-950 lg:flex">
            <div class="px-5 py-5"><?php echo $__env->make('partials.logo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div>
            <nav class="flex-1 space-y-1 px-3 py-4">
                <a href="<?php echo e(route('member.dashboard')); ?>" class="<?php echo e(request()->routeIs('member.dashboard') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
...
<?php $component = App\View\Components\Icon::resolve(['name' => 'home','class' => 'h-4 w-4'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> Overview
                ...
                <a href="<?php echo e(route('member.courses.index')); ?>" class="<?php echo e(request()->routeIs('member.courses.*') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
                    <?php if (isset($component)) { $__componentOriginald88937ee957874c050ccbc67a5e19575 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald88937ee957874c050ccbc67a5e19575 = $attributes; } ?>
...
<?php endif; ?> My Courses
                ...
                <a href="<?php echo e(route('member.robots.index')); ?>" class="<?php echo e(request()->routeIs('member.robots.*') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
                    <?php if (isset($component)) { $__componentOriginald88937ee957874c050ccbc67a5e19575 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald88937ee957874c050ccbc67a5e19575 = $attributes; } ?>
...
<?php endif; ?> Robots
                ...
                <a href="<?php echo e(route('member.signals.index')); ?>" class="<?php echo e(request()->routeIs('member.signals.*') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
                    <?php if (isset($component)) { $__componentOriginald88937ee957874c050ccbc67a5e19575 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald88937ee957874c050ccbc67a5e19575 = $attributes; } ?>
...
<?php endif; ?> Signals
                ...
                <a href="<?php echo e(route('member.mentorship.index')); ?>" class="<?php echo e(request()->routeIs('member.mentorship.*') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
                    <?php if (isset($component)) { $__componentOriginald88937ee957874c050ccbc67a5e19575 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald88937ee957874c050ccbc67a5e19575 = $attributes; } ?>
...
<?php endif; ?> Mentorship
                ...
                <a href="<?php echo e(route('member.billing.index')); ?>" class="<?php echo e(request()->routeIs('member.billing.*') ? 'nav-link-active' : 'nav-link'); ?> flex items-center gap-3">
                    <?php if (isset($component)) { $__componentOriginald88937ee957874c050ccbc67a5e19575 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald88937ee957874c050ccbc67a5e19575 = $attributes; } ?>
...
<?php endif; ?> Billing
            ...
            <div class="border-t border-white/5 p-4">
                <div class="mb-3 flex items-center gap-3">
                    <div class="flex h-9 w-9 items-center justify-center rounded-full bg-brand-500/20 text-sm font-semibold text-brand-300">
        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between border-b border-white/5 bg-navy-950 px-4 py-3 lg:hidden">
                ...
                <a href="<?php echo e(route('member.dashboard')); ?>" class="text-xs text-slate-400">Menu</a>
            </div>

            <main class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                <?php if(isset($header)): ?>
                    <div class="mb-8"><?php echo e($header); ?></div>
                <?php endif; ?>
