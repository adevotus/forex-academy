...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Reports']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Reports']); ?>
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="flex items-center gap-1 rounded-xl border border-slate-200 bg-slate-50 p-1">
            <?php $__currentLoopData = [3 => '3 Months', 6 => '6 Months', 12 => '12 Months']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(request()->fullUrlWithQuery(['period' => $val])); ?>"
                   class="rounded-lg px-4 py-1.5 text-sm font-semibold transition
                          <?php echo e($period == $val ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'); ?>">
                    <?php echo e($label); ?>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-slate-900"><?php echo e($fmtMoney($totalRevenue)); ?></p>
            <p class="mt-1 text-xs text-slate-400">This month: <span class="font-semibold text-emerald-600"><?php echo e($fmtMoney($thisMonthRevenue)); ?></span></p>
        </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-slate-900"><?php echo e($approvedPayments); ?></p>
            <p class="mt-1 text-xs text-slate-400">
                <span class="font-semibold text-amber-500"><?php echo e($pendingPayments); ?> pending</span>
                &nbsp;·&nbsp;
                <span class="text-rose-500"><?php echo e($rejectedPayments); ?> rejected</span>
            </p>
        </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-slate-900"><?php echo e($totalMembers); ?></p>
            <p class="mt-1 text-xs text-slate-400">Active: <span class="font-semibold text-violet-600"><?php echo e($activeMembers); ?></span> &nbsp;·&nbsp; New this month: <span class="font-semibold"><?php echo e($newThisMonth); ?></span></p>
        </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-slate-900"><?php echo e(number_format(array_sum($visitData))); ?></p>
            <p class="mt-1 text-xs text-slate-400">Unique: <span class="font-semibold text-amber-600"><?php echo e(number_format(array_sum($uniqueVisitData))); ?></span> in last <?php echo e($period); ?> months</p>
        </div>
    </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    ?>
                    <?php $__currentLoopData = $paymentByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between gap-2">
                            <div class="flex items-center gap-2 min-w-0">
                                <span class="h-2.5 w-2.5 flex-shrink-0 rounded-full" style="background:<?php echo e($typeColors[$pt->type] ?? '#94a3b8'); ?>"></span>
                                <span class="truncate text-xs text-slate-600 capitalize"><?php echo e(str_replace('_', ' ', $pt->type)); ?></span>
                            </div>
                            <div class="text-right flex-shrink-0">
                                <span class="text-xs font-semibold text-slate-800"><?php echo e($fmtMoney($pt->total)); ?></span>
                                <span class="ml-1 text-xs text-slate-400">(<?php echo e(round($pt->total / $typeTotal * 100)); ?>%)</span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($paymentByType->isEmpty()): ?>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    ?>
                    <?php $__currentLoopData = $memberStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between gap-2">
                            <div class="flex items-center gap-2">
                                <span class="h-2.5 w-2.5 rounded-full flex-shrink-0" style="background:<?php echo e($statusColors[$ms->status] ?? '#94a3b8'); ?>"></span>
                                <span class="text-xs text-slate-600 capitalize"><?php echo e($ms->status); ?></span>
                            </div>
                            <div class="text-right">
                                <span class="text-xs font-semibold text-slate-800"><?php echo e($ms->count); ?></span>
                                <span class="ml-1 text-xs text-slate-400">(<?php echo e(round($ms->count / $memberTotal * 100)); ?>%)</span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div class="mb-6 rounded-2xl border border-indigo-100 bg-indigo-50 p-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <?php $__currentLoopData = $predictLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl border border-indigo-200 bg-white p-4">
                    <p class="text-xs font-semibold text-indigo-400 uppercase tracking-wide mb-3"><?php echo e($pLabel); ?></p>
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="flex items-center gap-1.5 text-xs text-slate-500">
                                <span class="h-1.5 w-1.5 rounded-full bg-emerald-500"></span>Revenue
                            </span>
                            <span class="text-sm font-bold text-slate-800">$<?php echo e(number_format($revenuePredict[$i] ?? 0, 2)); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="flex items-center gap-1.5 text-xs text-slate-500">
                                <span class="h-1.5 w-1.5 rounded-full bg-violet-500"></span>Sign-ups
                            </span>
                            <span class="text-sm font-bold text-slate-800"><?php echo e(number_format($registrationPredict[$i] ?? 0)); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="flex items-center gap-1.5 text-xs text-slate-500">
                                <span class="h-1.5 w-1.5 rounded-full bg-amber-500"></span>Visits
                            </span>
                            <span class="text-sm font-bold text-slate-800"><?php echo e(number_format($visitPredict[$i] ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-6 py-4">
            ...
            <form method="GET" action="<?php echo e(route('admin.reports')); ?>" class="flex flex-wrap items-center gap-2">
                ...
                <select name="type" onchange="this.form.submit()"
                    ...
                    <?php $__currentLoopData = ['registration','course','robot','signal_subscription','mentorship']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t); ?>" <?php echo e($typeFilter == $t ? 'selected' : ''); ?>><?php echo e(ucfirst(str_replace('_', ' ', $t))); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($statusFilter || $typeFilter): ?>
                    <a href="<?php echo e(route('admin.reports', ['period' => $period])); ?>"
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-slate-800"><?php echo e($payment->user->name ?? '—'); ?></p>
                            ...
                            <td class="px-6 py-3">
                                <span class="rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-600">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $payment->type))); ?>

                                </span>
                            </td>
                            <td class="px-6 py-3 font-semibold text-slate-800">
                                <?php echo e($fmtMoney($payment->amount)); ?>

                                <?php if($payment->currency !== 'USD'): ?>
                                    <span class="text-xs text-slate-400"><?php echo e($payment->currency); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-3">
                                <?php
                                ...
                                ?>
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ring-1 <?php echo e($badge); ?>">
        ...
        <?php if($recentPayments->count() >= 20): ?>
            <div class="border-t border-slate-100 px-6 py-3 text-center">
                <a href="<?php echo e(route('admin.payments.index')); ?>" class="text-xs font-semibold text-brand-500 hover:text-brand-600 transition">
                    View all payments →
                </a>
            </div>
        <?php endif; ?>
    ...
    <script>
    (function () {
        const allLabels  = <?php echo json_encode($allLabels, 15, 512) ?>;
        const histCount  = <?php echo e(count($labels)); ?>;
        ...
        new Chart(document.getElementById('revenueChart'), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Revenue ($)',
                        data: <?php echo json_encode($revHistory, 15, 512) ?>,
                    ...
                    {
                        label: 'Predicted ($)',
                        data: <?php echo json_encode($revPredict, 15, 512) ?>,
                        type: 'line',
                        borderColor: '#6ee7b7',
                        borderDash: [6, 4],
                        borderWidth: 2,
        ...
        new Chart(document.getElementById('registrationsChart'), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Sign-ups',
                        data: <?php echo json_encode($regHistory, 15, 512) ?>,
                        borderColor: '#8b5cf6',
                    ...
                    {
                        label: 'Predicted',
                        data: <?php echo json_encode($regPredict, 15, 512) ?>,
                        borderColor: '#c4b5fd',
                        borderDash: [6, 4],
                        borderWidth: 2,
                        fill: false,
        ...
        new Chart(document.getElementById('visitsChart'), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Total Visits',
                        data: <?php echo json_encode($visHistory, 15, 512) ?>,
                        borderColor: '#f59e0b',
                    ...
                    {
                        label: 'Unique Visits',
                        data: <?php echo json_encode($uniqHistory, 15, 512) ?>,
                        borderColor: '#fcd34d',
                        borderWidth: 2,
                        fill: false,
                        tension: 0.4,
                    ...
                    },
                    {
                        ...
                        data: <?php echo json_encode($visPredict, 15, 512) ?>,
                        borderColor: '#fde68a',
                        borderDash: [6, 4],
                        borderWidth: 2,
                        fill: false,
        ...
        new Chart(document.getElementById('paymentTypeChart'), {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($paymentByType->pluck('type')->map(fn($t) => ucfirst(str_replace('_', ' ', $t)))->toArray()) ?>,
                datasets: [{
                    data: <?php echo json_encode($paymentByType->pluck('total')->map(fn($v) => round($v/100, 2))->toArray(), 512) ?>,
                    backgroundColor: <?php echo json_encode($paymentByType->pluck('type')->map(fn($t) => $typeColors[$t] ?? '#94a3b8')->toArray(), 15, 512) ?>,
                    borderWidth: 2,
                    borderColor: '#fff',
                    hoverOffset: 4,
                }]
        ...
        new Chart(document.getElementById('memberStatusChart'), {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($memberStatuses->pluck('status')->map(fn($s) => ucfirst($s))->toArray(), 15, 512) ?>,
                datasets: [{
                    data: <?php echo json_encode($memberStatuses->pluck('count')->toArray(), 15, 512) ?>,
                    backgroundColor: <?php echo json_encode($memberStatuses->pluck('status')->map(fn($s) => $statusColors[$s] ?? '#94a3b8')->toArray(), 15, 512) ?>,
                    borderWidth: 2,
                    borderColor: '#fff',
                    hoverOffset: 4,
                }]
...
<?php endif; ?>
<?php /**PATH D:\projects\emmiox-academy\emmiox-academy\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>