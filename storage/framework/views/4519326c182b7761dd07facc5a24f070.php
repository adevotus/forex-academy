...
?>
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="card flex items-center gap-4 p-5">
            ...
            <div>
                <p class="text-xs font-medium text-slate-500">Site Visitors</p>
                <p class="text-2xl font-extrabold text-slate-900"><?php echo e(number_format($stats['site_visitors'])); ?></p>
                <p class="mt-0.5 text-xs text-slate-400">unique IPs tracked</p>
            </div>
        </div>
