<form method="POST" action="<?php echo e(route('member.pending.proof')); ?>" enctype="multipart/form-data" class="space-y-3">
    <?php echo csrf_field(); ?>
    <?php if($errors->any()): ?>
...
<?php /**PATH D:\projects\emmiox-academy\emmiox-academy\resources\views/member/partials/proof-upload-form.blade.php ENDPATH**/ ?>