...
<?php $component->withAttributes(['title' => 'Mentorship Packages']); ?>
    ...
    JSON.parse(document.getElementById('mentor-sessions-data').textContent)
        .forEach(function(s) { mentorSessionsMap[s.id] = s; });
    ...
    function editMentor(id) {
        ...
        document.getElementById('m-price').value = s.price ? (s.price / 100).toFixed(2) : '';
